package com.tltemplates.client.model;
...
public class TLTemplatesItemLayerModel implements IUnbakedGeometry<TLTemplatesItemLayerModel> {
	 @Nullable
	    ...
	    private TLTemplatesItemLayerModel(@Nullable ImmutableList<Material> textures, Int2ObjectMap<ForgeFaceData> layerData, Int2ObjectMap<ResourceLocation> renderTypeNames)
	    {
	...
	public static final class Loader implements IGeometryLoader<TLTemplatesItemLayerModel>
    {
        public static final Loader INSTANCE = new Loader();

        @Override
        public TLTemplatesItemLayerModel read(JsonObject jsonObject, JsonDeserializationContext deserializationContext)
        {
            ...
            return new TLTemplatesItemLayerModel(null, emissiveLayers, renderTypeNames);
        }
